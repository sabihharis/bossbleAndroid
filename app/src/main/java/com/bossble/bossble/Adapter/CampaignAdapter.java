...
public class CampaignAdapter extends RecyclerView.Adapter<CampaignAdapter.ViewHolderForCat> {

    private Context mcontext ;
    List<Campaigns> mnames=new ArrayList<>();
    String imgfwd="";

    public CampaignAdapter(Context mcontext , List<Campaigns> names){
    ...
    @NonNull
    @Override
    public CampaignAdapter.ViewHolderForCat onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View myitem = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.campaigns_itemlayout , viewGroup , false);
        ViewHolderForCat viewHolderForCat =new ViewHolderForCat(myitem);
        return viewHolderForCat;
    }

    @Override
    public void onBindViewHolder(@NonNull final CampaignAdapter.ViewHolderForCat viewHolderForCat, final int i) {
        ...
        if (!campaigns.getImage().equals("")){
            ...
            mDrawable.setTint(Color.parseColor(campaigns.getDescription_background()));
            viewHolderForCat.image.setBackground(mDrawable);

            if (!campaigns.getDescription_fonts().equals("")){
                viewHolderForCat.name.setTypeface(Typeface.createFromAsset(mcontext.getAssets(),"Fonts/"+campaigns.getDescription_fonts()));
            }
