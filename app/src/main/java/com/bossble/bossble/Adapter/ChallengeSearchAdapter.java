...
//ChallengeSearchAdapter

public class ChallengeSearchAdapter extends RecyclerView.Adapter<ChallengeSearchAdapter.ViewHolderForCat> {

    private Context mcontext ;
    ArrayList<ChallengeSearch> mnames=new ArrayList<>();
    String identifier="";

    public ChallengeSearchAdapter(Context mcontext , ArrayList<ChallengeSearch> names){
    ...
    @NonNull
    @Override
    public ChallengeSearchAdapter.ViewHolderForCat onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final ChallengeSearchAdapter.ViewHolderForCat viewHolderForCat, final int i) {
