...
public class ShowAllNearByAdapter extends RecyclerView.Adapter<ShowAllNearByAdapter.ViewHolderForCat> {

    private Context mcontext ;
    List<NearBy_Challenges> mnames=new ArrayList<>();
    String imgfwd="";

    public ShowAllNearByAdapter(Context mcontext , List<NearBy_Challenges> names){
    ...
    @NonNull
    @Override
    public ShowAllNearByAdapter.ViewHolderForCat onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final ShowAllNearByAdapter.ViewHolderForCat viewHolderForCat, final int i) {
        ...
        final NearBy_Challenges campaigns = mnames.get(i);
