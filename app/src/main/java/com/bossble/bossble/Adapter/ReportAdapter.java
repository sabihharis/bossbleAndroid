...
public class ReportAdapter extends RecyclerView.Adapter<ReportAdapter.ViewHolderForCat> {
    ...
    ArrayList<ReportUser> mnames=new ArrayList<>();
    String identifier="";

    public ReportAdapter(Context mcontext , ArrayList<ReportUser> names){
    ...
    public ReportAdapter.ViewHolderForCat onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View myitem = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.report_itemlayout , viewGroup , false);
    ...
    public void onBindViewHolder(@NonNull final ReportAdapter.ViewHolderForCat viewHolderForCat, final int i) {
      ...
      /*  final ChallengeSearch challengeSearch = mnames.get(i);
        ...
        final ReportUser reportUser = mnames.get(i);

        String u_id = reportUser.getU_id();
        String challenge_id = reportUser.getChallenge_id();
        String title = reportUser.getTitle();
        ...
        {
            viewHolderForCat.txtpeoplename.setText(title);
        }
    ...
    public void updateList(ArrayList<ReportUser> list){
        mnames = list;
